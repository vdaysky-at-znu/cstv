...
import DiscussionModelFactory, { IDiscussion, IDiscussionType } from "./discussion";
import GameModelFactory,{ IGame, IGameType } from "./game";
import PlayerModelFactory, { IPlayer, IPlayerType } from "./player";
import UserModelFactory, { IUser, IUserType } from "./user";
import PlayerStatsModelFactory, { IPlayerStats, IPlayerStatsType } from "./playerStats";
import PostModelFactory, { IPost, IPostType } from "./post";
import RoundModelFactory, { IRound, IRoundType } from "./round";
import EventModelFactory, { IEvent, IEventType } from "./event";
import MatchModelFactory, { IMatch, IMatchType } from "./match";
...
export interface IModelContainer {
    Post: IPostType;
    Team: ITeamType;
    Discussion: IDiscussionType;
    Match: IMatchType;
    Event: IEventType;
    Game: IGameType;
    Player: IPlayerType;
    PlayerStats: IPlayerStatsType;
    Round: IRoundType;
    User: IUserType;
...
export default {
    Team: awilix.asFunction(TeamModelFactory).singleton(),
    Player: awilix.asFunction(PlayerModelFactory).singleton(),
    User: awilix.asFunction(UserModelFactory).singleton(),
    Discussion: awilix.asFunction(DiscussionModelFactory).singleton(),
    Event: awilix.asFunction(EventModelFactory).singleton(),
    Match: awilix.asFunction(MatchModelFactory).singleton(),
    Game: awilix.asFunction(GameModelFactory).singleton(),
    PlayerStats: awilix.asFunction(PlayerStatsModelFactory).singleton(),
    Post: awilix.asFunction(PostModelFactory).singleton(),
    Round: awilix.asFunction(RoundModelFactory).singleton(),
}; 
